...
interface MergeFormCanonicalProps {
...
/// Canonical 3-radio merge form for GitHub + Gitea. Both providers
/// honour the same `MergeRequest` shape (method + optional title /
/// message + delete-branch toggle) so this body is shared.
export function MergeFormCanonical(props: MergeFormCanonicalProps) {
