...
//!   - [`push`]          — push HEAD, delete remote branches, push and
//!                          delete remote tags. Anything that writes to
//!                          a remote ref via the push wire.
//!   - [`sync`]          — fetch_one / fetch_prune / pull / force_pull.
//!                          Anything that reads from the remote.
//!
