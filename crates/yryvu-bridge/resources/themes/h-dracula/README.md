...
> Designer neon — purple→pink gradients, cut-corner buttons, and vampiric glows.

**Scheme:** dark

## What it is

Overrides `--btn-clip-path` for beveled buttons; gradient washes on accent surfaces.
...
- In-app: **Preferences → UI → Duplicate "Dracula" as new theme**, then edit the
