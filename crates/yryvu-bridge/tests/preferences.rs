...
use yryvu_bridge::preferences::{
    ...
    EolCharacter, ExternalTerminal, GeneralPreferences, IssueTrackerPreferences,
    NotificationsPreferences, PermanentTabState, PermanentTabs, Preferences, PreferencesError, Tab,
