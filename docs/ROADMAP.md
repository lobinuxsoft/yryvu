...
| **9 — Perf + cleanup** | lazy hunks (#178), stream layout (#181), RepoMgmt DOD (#217), cols resize (#37), don't-ask (#196), remote mgmt (#132), HEAD-first (#126), deeplinks (#110), commit-panel parity (#151), BYO OAuth (#263), GK audit (#33) | v0.5.x → v0.6.x | ⬜ next (start with #217) |
